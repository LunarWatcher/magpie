...
Until then, you can mix in another library. The webserver and websocket server need to listen on different ports anyway, so they'll have separate resource pools regardless of whether you use one or two libraries.
